...
const CreditNoteItemTable = (props) => {
    ...
    const handleDelete = async (customerId) => {
        const confirmDelete = window.confirm("Are you sure you want to delete this Credit Note Item?");
                                        ...
                                        <Tbody>
                                            {customers.map(creditNote => (
                                                <Tr key={creditNote.id}>
                                                    <Td>{creditNote.credit_note.credit_note_number}</Td>
                                                    <Td>{creditNote.description}</Td>
                                                    <Td>{creditNote.quantity}</Td>
                                                    <Td>{creditNote.unit_price}</Td>
...
export default connect(null, { setBreadcrumbItems })(CreditNoteItemTable);